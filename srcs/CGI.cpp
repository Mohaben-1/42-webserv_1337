...
void	CGI::setupFromRequest(const Request& req, const std::string& script, const std::string& interpreter, const std::string& doc_root, int port, const std::string& srv_name)
{
	script_path = script;
